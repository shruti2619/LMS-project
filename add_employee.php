...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header" style="color: green;"  ><h2 style="margin-right: 10px;">Employee Details</h2></div>
                           ...
                           <form method="post">
							   <div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" value="<?php echo $mobile?>" name="mobile" placeholder="Enter mobile no." class="form-control" required>
								</div>
								<div class="form-group">
									<label class=" form-control-label">Password</label>
									<input type="text" value="<?php echo $password?>" name="password" placeholder="Enter password" class="form-control" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="date" value="<?php echo $doj?>" name="dateofjoin" placeholder="Enter employee birthday" class="form-control">
								</div>
